export default {
  ...
  en: {
    ...
    kg: 'kg',
    cart: 'Cart',
    invoiceShippingCost: 'Invoice Shipping Cost',
    selecteUser: 'Client Info',
    modifyAddress: 'Modify Client',
    selectGoods: 'Select Goods',
    selectedGoods: 'Selected Goods',
    logisticPrice: 'Logistic Price',
    chooseLogistic: 'Choose Logistics',
    myGoods: 'Products Detail',
    totalQuantity: 'Total Quantity',
    shouldPayLogisiticFee: 'Logistics Fee',
    goodsCost: 'Products Cost',
