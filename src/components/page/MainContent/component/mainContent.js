...
import { Order, MarketingMaterials, Accounts, Leads, PriceSetting, TrackOrders, FreightCost, Inventory } from 'views/index';
...
const mainContentView = () => (
  <Switch>
    ...
    <Route path="/freightCost" component={FreightCost} />
